...
- Docs consulted:
  ...
  - Upstream modules (if any): <!-- TODO: include module path and summarize key findings -->

# Child modules used
Use existing child modules from the repository in root module:
...
<!-- TODO: Summarize findings from investigation steps where you used repository directory modules/ to find information related to the module. -->
