...
Root modules should avoid embedding complex, reusable logic that would be better served as a dedicated module. When a root module’s internal wiring becomes repetitive across stacks, extract a reusable module and keep the root focused on composition.
