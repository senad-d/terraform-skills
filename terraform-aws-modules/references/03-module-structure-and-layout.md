...
- Inputs and outputs do not need manual documentation because they are generated by
  tooling.
- If you embed images or link to repository files, use commit-specific absolute URLs
  to avoid version drift.
- Consider including a diagram depicting the infrastructure resources the module
